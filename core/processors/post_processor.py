...
class GraphPostProcessor:
    ...
    # Updated regex to capture 1, 1.2, 1.2.3
    ...
    def process(self, document: Document, nodes: List[Node], edges: List[Edge]) -> Tuple[Document, List[Node], List[Edge]]:
        ...
        # 1. Build the reference lookup table
        ref_lookup = self._build_ref_lookup(nodes)
        
        # 2. Execute Pillar C (Contextual Augmentation)
        self._augment_context(nodes, node_map)
        
        # 3. Execute Pillar B (Cross-Reference Resolution)
        self._resolve_cross_references(nodes, edges, ref_lookup)
        
        # 4. Execute Pillar A (Spatial Topology Generation)
        self._extract_spatial_relations(nodes, edges)
        
        # 5. Execute Pillar D (Evidence Templating)
    ...
    # ==========================================
    # PILLAR B SETUP: Reference Lookup Builder
    # ==========================================
    def _build_ref_lookup(self, nodes: List[Node]) -> Dict[str, Dict[str, str]]:
        """
        Scans Image, Table, Formula, and Section nodes directly for numbers.
        """
    ...
    # ==========================================
    # PILLAR C: Contextual Augmentation
    # ==========================================
    ...
    # ==========================================
    # PILLAR B: Cross-Reference Resolution
    # ==========================================
                ...
                if target_id and target_id != node.id:
                    ...
                    if edge_key not in existing_edges:
                        edges.append(Edge(
                            ...
                            target_id=target_id,
                            type="references",
                            type_category=EdgeCategory.REFERENCE,
    ...
    # ==========================================
    # PILLAR A: Spatial Topology Generation
    # ==========================================
    ...
    def _add_spatial_edge(self, edges: List[Edge], existing: set, src: Node, tgt: Node, 
                          rel_type: str, bidirectional: bool):
        ...
        edges.append(Edge(
            ...
            target_id=tgt.id,
            type=rel_type,
            type_category=EdgeCategory.SPATIAL_RELATION,
